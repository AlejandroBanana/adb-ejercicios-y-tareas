...
# Definir los datos para los productos
productos = [
...
with open(nombre_fichero, mode='w', newline='', encoding='utf-8') as fichero:
    ...
    escritor = csv.DictWriter(fichero, fieldnames=['Producto', 'Categoria', 'Precio', 'Stock'], delimiter=delimitador)

    # Escribir los registros en el archivo sin la cabecera
